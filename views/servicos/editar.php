...
<form method="post" action="">
    <label>Nome:</label><br>
    <input type="text" name="nome" value="<?= htmlspecialchars($servico['nome'] ?? '') ?>" required><br>
    <label>Descrição:</label><br>
    <textarea name="descricao"><?= htmlspecialchars($servico['descricao'] ?? '') ?></textarea><br>
    <label>Preço:</label><br>
    <input type="number" step="0.01" name="preco" value="<?= htmlspecialchars($servico['preco'] ?? '') ?>" required><br>
